# agrowise ![](https://github.com/ibukun-brain/agrowise/workflows/CI/badge.svg)
...
### Pre development
- Go to the Github issues (https://github.com/ibukun-brain/agrowise/issues/)
...
```sh
git checkout -b agrowise-1/lowercased-short-description
```
...
Pick a ticket on the [Github Repository](https://github.com/ibukun-brain/agrowise). If you haven't cloned the repository, use the command to clone from the terminal

```sh
git clone https://github.com/ibukun-brain/agrowise
```

When creating a new branch, **ENSURE** that the branch name starts with the format **SSS-&lt;issue-no&gt;-&lt;short-description&gt;** e.g. **agrowise-1-project-setup** and the main branch is from develop. use the command below when creating a new branch.
