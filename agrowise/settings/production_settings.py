...
from agrowise.settings.local.email_settings import *
from agrowise.settings.packages.cloudinary_settings import *
...
ALLOWED_HOSTS.append("agrowise-api.vercel.app")
